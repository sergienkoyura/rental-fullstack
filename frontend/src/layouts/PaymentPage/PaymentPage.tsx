        ...
        <div className="container">
            {fees > 0 && <div className="card mt-3">
                ...
                <div className="card-body">
                    ...
                    <button onClick={checkout} disabled={submitDisabled} type="button" className="btn btn-md main-color text-white mt-3">
                        Pay fees
                    </button>
                </div>
            </div>}
            ...
            {fees === 0 &&
                <div className="mt-3">
                    ...
                    <Link type="button" className="btn main-color text-white" to={'search'}>Explore top items</Link>
                </div>
            }
